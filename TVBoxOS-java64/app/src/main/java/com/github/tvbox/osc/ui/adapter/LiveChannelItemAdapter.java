...
public class LiveChannelItemAdapter extends BaseQuickAdapter<LiveChannelItem, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder holder, LiveChannelItem item) {
        ...
        if (channelIndex == selectedChannelIndex && channelIndex != focusedChannelIndex) {
            tvChannelNum.setTextColor(mContext.getResources().getColor(R.color.apple_tv_text_primary));
            tvChannel.setTextColor(mContext.getResources().getColor(R.color.apple_tv_text_primary));
        }
        else{
            tvChannelNum.setTextColor(mContext.getResources().getColor(R.color.apple_tv_text_secondary));
            tvChannel.setTextColor(mContext.getResources().getColor(R.color.apple_tv_text_primary));
        }
    }
