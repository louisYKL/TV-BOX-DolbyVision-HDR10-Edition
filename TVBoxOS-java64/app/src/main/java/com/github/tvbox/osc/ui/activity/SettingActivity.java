...
public class SettingActivity extends BaseActivity {
        ...
        mGridView.setOnItemListener(new TvRecyclerView.OnItemListener() {
            ...
            public void onItemPreSelected(TvRecyclerView parent, View itemView, int position) {
                if (itemView != null) {
                    ...
                    tvName.setTextColor(getResources().getColor(R.color.apple_tv_text_primary));
                }
            }
            ...
            public void onItemSelected(TvRecyclerView parent, View itemView, int position) {
                if (itemView != null) {
                    ...
                    tvName.setTextColor(getResources().getColor(R.color.apple_tv_selected_text_dark));
                }
            }
    ...
    private void initData() {
        ...
        initViewPager();
        mGridView.post(() -> {
            View itemView = mGridView.getLayoutManager() == null ? null : mGridView.getLayoutManager().findViewByPosition(0);
            if (itemView != null) {
