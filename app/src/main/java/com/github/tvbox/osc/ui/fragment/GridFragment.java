...
//        if(this.focusedView != null){ this.focusedView.requestFocus(); }
    ...
    private void createView() {
        ...
        if(mGridView == null){ // 从layout中拿view
            ...
            int spacing = getResources().getDimensionPixelSize(R.dimen.vs_18);
    ...
    private void initView() {
        ...
        int gridSpacing = getResources().getDimensionPixelSize(R.dimen.vs_18);
        mGridView.setSpacingWithMargins(gridSpacing, gridSpacing);
