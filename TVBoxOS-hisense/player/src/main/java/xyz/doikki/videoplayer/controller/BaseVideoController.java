...
public abstract class BaseVideoController extends FrameLayout
    ...
    protected void initView() {
        ...
        showSet.setInterpolator(new DecelerateInterpolator(1.55f));
        showSet.addAnimation(new AlphaAnimation(0f, 1f));
        showSet.addAnimation(new TranslateAnimation(0f, 0f, 36f, 0f));
        showSet.setDuration(360);
        mShowAnim = showSet;

        AnimationSet hideSet = new AnimationSet(true);
        hideSet.setInterpolator(new DecelerateInterpolator(1.15f));
        hideSet.addAnimation(new AlphaAnimation(1f, 0f));
        hideSet.addAnimation(new TranslateAnimation(0f, 0f, 0f, 28f));
        hideSet.setDuration(280);
        mHideAnim = hideSet;
