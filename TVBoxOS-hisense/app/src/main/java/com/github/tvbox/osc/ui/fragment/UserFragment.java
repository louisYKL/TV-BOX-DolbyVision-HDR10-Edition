...
public class UserFragment extends BaseLazyFragment implements View.OnClickListener {
    ...
    protected void onFragmentResume() {
        ...
        if (Hawk.get(HawkConfig.HOME_REC_STYLE, false)) {
            ...
            int paddingLeft = getResources().getDimensionPixelSize(R.dimen.vs_24);
            int paddingTop = getResources().getDimensionPixelSize(R.dimen.vs_14);
            int paddingRight = getResources().getDimensionPixelSize(R.dimen.vs_24);
            int paddingBottom = getResources().getDimensionPixelSize(R.dimen.vs_18);
            ...
            int paddingLeft = getResources().getDimensionPixelSize(R.dimen.vs_24);
            int paddingTop = getResources().getDimensionPixelSize(R.dimen.vs_30);
            int paddingRight = getResources().getDimensionPixelSize(R.dimen.vs_24);
            int paddingBottom = getResources().getDimensionPixelSize(R.dimen.vs_30);
            tvHotList.setPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
        }
    ...
    protected void init() {
        ...
        tvHotList.setOnItemListener(new TvRecyclerView.OnItemListener() {
            ...
            public void onItemPreSelected(TvRecyclerView parent, View itemView, int position) {
                FocusAnim.apply(itemView, false, 1.03f);
            }

            @Override
            public void onItemSelected(TvRecyclerView parent, View itemView, int position) {
                FocusAnim.apply(itemView, true, 1.03f);
            }
    ...
    private View.OnFocusChangeListener focusChangeListener = new View.OnFocusChangeListener() {
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            FocusAnim.apply(v, hasFocus, 1.025f);
        }
    };
